...
public class UserController {
    ...
    public UserController(UserService userService, CheckErrorValidator checkErrorValidator) {
		super();
		this.userService = userService;
		this.checkErrorValidator = checkErrorValidator;
	}
	@InitBinder
	...
	@PostMapping("/new")
    public Long createUser(@Valid @RequestBody UserSaveDTO userSaveDTO, Errors errors, Model model) {
        // 검증
        if (errors.hasErrors()) {
            // 회원가입 실패 시 입력 데이터 유지
